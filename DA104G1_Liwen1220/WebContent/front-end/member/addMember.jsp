  ...
  <div class="collapse navbar-collapse d-xs-flex justify-content-end mr-5" id="navbarSupportedContent">
    <ul class="navbar-nav">
                    <!-- <li class="nav-item">
                      ...
                      <li class="nav-item mr-3">
                        <a class="nav-link" href="#"><i class="fas fa-users"></i><span>揪團</span></a>
                      </li>
  <!-- ---------會員登入後，變更----------- -->
                    <li class="nav-item mr-3">
			...
			<c:forEach var="message" items="${errorMsgs}">
				<li style="color: red">${message}</li>
                            ...
                            <div class="forgotpw" class="container">
                              <form class="form-signin" method="post" action="<%=request.getContextPath()%>/member/member.do" name="form1" enctype="multipart/form-data">
                                <div class="row">
                                  <div class="col-6">
                                    <label for="inputaccount">帳號</label>
                                                         
<span id="showthesame"></span>
										
                                    <p><input type="text" id="mem_account" name="mem_account" class="form-control" placeholder="Account" required autofocus value="<%=(memberVO == null) ? "" : memberVO.getMem_account()%>"></p>
                                    
                                    <label for="pw">密碼</label>
                                    <p><input type="password" id="pw" name="mem_password" class="form-control" placeholder="Password" required value="<%=(memberVO == null) ? "" : memberVO.getMem_password()%>"></p>
                                    <label for="ckpw">確認密碼</label>
                                    <span id="showError"></span>
                                    <p><input type="password" name="ck_password" id="ckpw" class="form-control" placeholder="Password" required value="<%=(memberVO == null) ? "" : memberVO.getMem_password()%>">
                                    
                                    </p>
                                  </div>
                                  <div class="col-6">
                                    <div id="showphoto"></div>
                                    <input type="file" name="mem_pic" class="uplaodfile" id="mem_pic" value="<%=(memberVO == null) ? "" : memberVO.getMem_pic()%>" style="border-radius: 0px">
                                  </div>  
                                ...
                                <div class="row">
                                  <div class="col-12">
                                    <hr class="my-4">
                                    <p class="sex">
                                      <label for="female"><input type ="radio" id = "female" name="gender" value = "1" <%=(memberVO == null || memberVO.getGender().equals("1")) ? "checked" : ""%>>女生<img src="<%=request.getContextPath()%>/images/woman.jpg"></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <label for="male"><input type ="radio" id = "male" name="gender" value = "0" <%=(memberVO != null && memberVO.getGender().equals("0")) ? "checked" : ""%>>男生 <img src="<%=request.getContextPath()%>/images/man.jpg"></label>
                                    </p>
                                    
                                    
                                    <label for="inputname">姓名</label>
                                    <p><input type="text" name="mem_name" id="inputaccount" class="form-control" placeholder="Name" required autofocus value="<%=(memberVO == null) ? "" : memberVO.getMem_name()%>">
                                    </p>
                                    <label for="inputDate">生日</label>
                                    <p><input type="text" name="birth" id="birth" class="form-control"required autofocus value="<%=(memberVO == null) ? "" : memberVO.getBirth()%>"></p>
                                    <label for="cellphone">手機</label>
                                    <p><input type="number" name="mem_mobi" id="cellphone" class="form-control"required autofocus placeholder="Phone" value="<%=(memberVO == null) ? "" : memberVO.getMem_mobi()%>"></p>
                                    <label for="email">電子信箱</label>
                                    <p><input type="email" name="mem_email" id="email" class="form-control"required autofocus placeholder="E-mail" value="<%=(memberVO == null) ? "" : memberVO.getMem_email()%>"></p>
                                    ...
                                    <p><input type="text" name="mem_addr" id="address" class="form-control"required autofocus placeholder="Address" value="<%=(memberVO == null) ? "" : memberVO.getMem_addr()%>"></p>
