						...
						<table>
							<tr>
								...
								<td><input type="text" name="ad_account" id="ad_account"
									value="<%=(adVO == null) ? "" : adVO.getAd_account()%>">
							...
							<tr>
								...
								<td><input type="text" name="ad_name"
									value="<%=(adVO == null) ? "" : adVO.getAd_name()%>"></td>
							</tr>

<tr>
<td>地址:</td>
<td>
<select id="city" name="city" style="width: 114px; height: 22px"></select>
<select style="width: 114px; height: 22px" id="district" name="district"></select><br>
<input type="text" name="ad_addr" value="<%=(adVO == null) ? "" : adVO.getAd_addr()%>">
</td>
</tr>
							<tr>
								<td>手機:</td>
								<td><input type="text" name="ad_mobi"
									value="<%=(adVO == null) ? "" : adVO.getAd_mobi()%>"></td>
							</tr>

							<tr>
								<td>電子信箱:</td>
								<td><input type="text" name="ad_email"
									value="<%=(adVO == null) ? "" : adVO.getAd_email()%>"></td>
							</tr>
